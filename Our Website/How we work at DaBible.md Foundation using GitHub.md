...
A submitted issue, comment, or pull request can have smaller components called a task. Task are lists—checklists you can use to coordinate and track parts of an issue. Reorder tasks as your priorities change, and check them off as you complete each one.
...
Tagging issues and pull requests with labels allow you to quickly search for them later. Filter your issues by [label](https://docs.github.com/articles/applying-labels-to-issues-and-pull-requests/) to find and reference all issues that are part of your project.
...
Visualize all of your work and prioritize it right alongside your code with project boards. See what tasks are planned or in progress, either in a repository or across your organization. 
